...
def when_group1_and_group2_start_a_match_to_group3_sets(
        step,
        group1,
        group2,
        group3):
...
def when_group1_won_the_group2_set_group3_group4(
        step,
        group1,
        group2,
        group3,
...
def and_group1_won_the_group2_set_group3_group4(
        step,
        group1,
        group2,
        group3,
